...
<body class="animated-bg min-h-screen flex items-center justify-center p-6 relative overflow-hidden">
    ...
    <div class="relative z-10 w-full max-w-5xl">
        ...
        <div class="grid md:grid-cols-2 gap-8 px-4">
            ...
            <!-- Card Survailen -->
            <a href="http://survailen.localhost:8001/dashboard" class="glass-card group rounded-3xl p-8 flex flex-col items-center text-center transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl cursor-pointer">
