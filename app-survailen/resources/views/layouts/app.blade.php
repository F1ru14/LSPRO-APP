        ...
        <header class="bg-white h-20 shadow-sm flex items-center justify-between px-4 md:px-10">
            <div class="flex items-center space-x-4 md:space-x-6">
                ...
                <div class="hidden md:flex items-center space-x-3 ml-2">
                    <a href="http://sertifikasi.lspro.test:8000/portal" class="px-4 py-1.5 bg-gray-800 text-white font-semibold rounded-lg hover:bg-gray-700 transition text-sm flex items-center space-x-1">
